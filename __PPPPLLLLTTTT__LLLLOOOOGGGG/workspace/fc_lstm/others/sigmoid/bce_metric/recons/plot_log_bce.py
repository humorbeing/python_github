...
plt.title('Reconstruction, sigmoid, Train with MSE vs BCE, show BCE loss')
train_mark = '-'
val_mark = ':'


name = '20200107-070719-0sm-z-r.txt'
title = 'M Z R'
c = 'r'
a = xy(name)
plt.plot(a[2], c+train_mark, label=title+' Tr')
plt.plot(a[6], c+val_mark, label=title+' Va')
#
...
name = '20200107-092905-0sb-z-recon.txt'
title = 'B Z R'
c = 'b'
a = xy(name)
plt.plot(a[2], c+train_mark, label=title+' Tr')
...
c = '#641E16'
a = xy(name)
plt.plot(a[2], color=c, linestyle=train_mark, label=title+' Tr')
plt.plot(a[6], color=c, linestyle=val_mark, label=title+' Va')
