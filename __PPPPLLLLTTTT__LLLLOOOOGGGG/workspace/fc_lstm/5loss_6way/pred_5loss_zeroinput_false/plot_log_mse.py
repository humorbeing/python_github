...
plt.title('Prediction, 5 losses, zero input: false')
train_mark = '-'
val_mark = ':'
...
name = '20200107-145446-0nm-zf-pred.txt'
title = '0 N M Zf P'
c = 'b'
a = xy(name)
plt.plot(a[3], c+train_mark, label=title+' Tr')
plt.plot(a[7], c+val_mark, label=title+' Va')
#
name = '20200107-171226-1tm-zf-pred.txt'
title = '1 T M Zf P'
c = 'y'
a = xy(name)
plt.plot(a[3], c+train_mark, label=title+' Tr')
plt.plot(a[7], c+val_mark, label=title+' Va')
#
name = '20200108-011757-1nm-zf-pred.txt'
title = '1 N M Zf P'
c = 'c'
a = xy(name)
plt.plot(a[3], c+train_mark, label=title+' Tr')
