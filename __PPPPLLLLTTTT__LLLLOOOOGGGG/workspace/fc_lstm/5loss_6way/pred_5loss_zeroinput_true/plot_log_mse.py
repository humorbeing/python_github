...
plt.title('Prediction, 5 losses, zero input: True')
train_mark = '-'
val_mark = ':'
...
name = '20200108-004228-0nm-z-pred.txt'
title = '0 N M Z P'
c = 'b'
a = xy(name)
plt.plot(a[3], c+train_mark, label=title+' Tr')
plt.plot(a[7], c+val_mark, label=title+' Va')
#
name = '20200108-031828-1tm-z-pred.txt'
title = '1 T M Z P'
c = 'y'
a = xy(name)
plt.plot(a[3], c+train_mark, label=title+' Tr')
plt.plot(a[7], c+val_mark, label=title+' Va')
#
name = '20200108-055413-1nm-z-pred.txt'
title = '1 N M Z P'
c = 'c'
a = xy(name)
plt.plot(a[3], c+train_mark, label=title+' Tr')
