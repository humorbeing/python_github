...
plt.title('Reconstruction, 5 losses, zero input: True')
train_mark = '-'
val_mark = ':'
...
name = '20200107-115149-0nm-z-recon.txt'
title = '0 N M Z R'
c = 'b'
a = xy(name)
plt.plot(a[1], c+train_mark, label=title+' Tr')
plt.plot(a[5], c+val_mark, label=title+' Va')
#
name = '20200107-140802-1tm-z-recon.txt'
title = '1 T M Z R'
c = 'y'
a = xy(name)
plt.plot(a[1], c+train_mark, label=title+' Tr')
plt.plot(a[5], c+val_mark, label=title+' Va')
#
name = '20200107-171717-1nm-z-recon.txt'
title = '1 N M Z R'
c = 'c'
a = xy(name)
plt.plot(a[1], c+train_mark, label=title+' Tr')
