...
plt.title('Reconstruction, 5 losses, zero input: False')
train_mark = '-'
val_mark = ':'
...
name = '20200109-120649-0nm-zf-recon.txt'
title = '0 N M Zf R'
c = 'b'
a = xy(name)
plt.plot(a[1], c+train_mark, label=title+' Tr')
plt.plot(a[5], c+val_mark, label=title+' Va')
#
name = '20200109-144244-1tm-zf-recon.txt'
title = '1 T M Zf R'
c = 'y'
a = xy(name)
plt.plot(a[1], c+train_mark, label=title+' Tr')
plt.plot(a[5], c+val_mark, label=title+' Va')
#
name = '20200109-172540-1nm-zf-recon.txt'
title = '1 N M Zf R'
c = 'c'
a = xy(name)
plt.plot(a[1], c+train_mark, label=title+' Tr')
