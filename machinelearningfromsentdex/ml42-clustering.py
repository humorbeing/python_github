...
class Mean_Shift:
    ...
    def fit(self, data):
        ...
        for i in range(len(data)):
            centroids[i] = data[i]
        #weights = [i for i in range(self.radius_norm_step)][::-1]#reverse array
...
for classification in clf.classifications:
    ...
    for featureset in clf.classifications[classification]:
        plt.scatter(featureset[0],featureset[1], marker = "x", color=color, s=250, linewidths = 20)#, zorder = 10)
