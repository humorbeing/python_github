...
code, its a good CNN implementation for study purpose.
    Experiment: So, during training, we can observe the loss value is
decreasing and converge to 0. It means model is able to be overfitted to small number of training samples.
    Considering all these dancing among around multi dimension manipulations, its almost
certain, that I have made some mistakes somewhere. The question is, "Are you good
enough to find them?", "Do you understand CNN well enough to notice them?"
