    ...
    def check44(self,Row):
        ...
        for leftnum in range(9):
            for top4block in range(9):
                #for i in range(4):
                check = [sum(self.A[9*leftnum+i][Row[top4block*9+j]] for j in range(9)) == 999 for i in range(9)]
                #print('b'*79)
                #print(b)
                if any(check):
                    ...
                    for i in range(9):
                        for j in range(9):
                            if self.A[9*leftnum+i][Row[top4block*9+j]] != 999:
                        ...
                        if n == 9:
                            ...
                            for j in range(9):
                                if self.A[9*leftnum+i][Row[top4block*9+j]] != 0:
                                    ...
                                    self.A[9*leftnum+i][Row[top4block*9+j]] += (n+1)**2
