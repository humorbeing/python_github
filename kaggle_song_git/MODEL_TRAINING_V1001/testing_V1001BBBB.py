...
models = [
    '[]_0.6736_Light_dart_1512798247.model',
    '[]_0.6725_Light_dart_1512749863.model',
    '[]_0.6692_Light_goss_1512749229.model',
    '[]_0.6595_Light_rf_1512749682.model'
]
for m in models:
    # !!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    if is_train:
        ...
        print('[complete] featuring, name:', model_name + '.csv')
