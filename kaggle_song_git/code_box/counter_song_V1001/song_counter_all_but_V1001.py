...
ccc.remove('ISC_rc_ln')
ccc.remove('ISCZ_artist_name')
ccc.remove('ISC_song_year')
ccc.remove('song_year')

ccc.remove('ISC_composer')
ccc.remove('ISC_lyricist_log10')
ccc.remove('song_length_log10')
ccc.remove('ISC_top2_in_song')

ccc.remove('ISCZ_genre_ids_log10')
ccc.remove('ISC_top1_in_song')
ccc.remove('ISCZ_song_country_log10')
ccc.remove('ISC_language')

ccc.remove('ISC_top3_in_song')
ccc.remove('ISCZ_isrc_rest')
ccc.remove('ISC_name_log10')

ccc.remove('ISCZ_rc')
ccc.remove('ISC_artist_name_log10')
ccc.remove('ISCZ_song_year')
ccc.remove('ISCZ_composer_log10')

ccc.remove('ISCZ_lyricist')
ccc.remove('ISC_genre_ids')
ccc.remove('ISC_song_country_ln')
ccc.remove('ISC_isrc_rest_log10')
ccc.remove('ISCZ_name_ln')
