...
ccc.remove('msno')
ccc.remove('membership_days')
ccc.remove('age_guess_log10')
ccc.remove('expiration_month_log10')
ccc.remove('bd_log10')
ccc.remove('bd_fixed_log10')
ccc.remove('bd_range_log10')
ccc.remove('bd_fixed_range_log10')
ccc.remove('age_guess_range_log10')
ccc.remove('IMC_age_guess_range_log10')
ccc.remove('IMC_age_guess_log10')
ccc.remove('IMC_bd_log10')
ccc.remove('IMC_bd_fixed_log10')
ccc.remove('IMC_expiration_month_log10')
ccc.remove('IMC_membership_days_log10')
ccc.remove('IMC_bd_range_log10')
ccc.remove('IMC_bd_fixed_range_log10')
# ccc.remove('')
# ccc.remove('')
# ccc.remove('')
# ccc.remove('')
