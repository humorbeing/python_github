...
-  automatic differentiation (``torch.autograd_playground``)
-  utilities for vision tasks (``torchvision`` - `a separate
   package <https://github.com/pytorch_playground/vision>`__).
...
#    ``torch.autograd_playground.Variable`` that will automatically send the data to
