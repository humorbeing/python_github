...
class MaximumMatching():
    ...
    def Xtraining(self):
        self.delta_X = self.oneoverx(self.receiveFlow)*self.XGetfrombackwardY#*self.Xscaler
        #self.Wx = self.oneoverx(np.dot(self.Xform,self.delta_X))*self.delta_X
        #print('XXXXXXX training XXXXXXXX')
        #print(self.XGetfrombackwardY)
        #print(self.FLOW)
        #print(self.delta_X)
        #print(self.Wx)
    def Ytraining(self):
        self.delta_Y = self.oneoverx(self.backFLOW)*self.YGetfromforwardX#*self.Yscaler
        #self.Wy = self.oneoverx(np.dot(self.Yform,self.delta_Y))*self.delta_Y
        '''
        print('YYYYY --training-- YYYYY')
        print(self.YGetfromforwardX)
        print(self.backFLOW)
        #print(self.oneoverx(self.backFLOW)*self.YGetfromforwardX)
        print(self.delta_Y)
        print(self.delta_Y*self.Yscaler)
        print('w'*20)
        print(self.Wy)
        print(self.oneoverx(np.dot(self.Yform,self.delta_Y*self.Yscaler))*self.delta_Y*self.Yscaler)
        '''
    def learning(self):
