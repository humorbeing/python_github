...
for _ in range(1000):
    ...
    no_train.append(test_acc)

print(no_train)
print('mean: {}'.format(np.mean(no_train)))
print('varience: {}'.format(np.var(no_train)))
print('standard deviation: {}'.format(np.std(no_train)))
print('max: {}'.format(np.max(no_train)))
print('min: {}'.format(np.min(no_train)))
