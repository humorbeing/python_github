...
def get_im_var(name='2.jpg', load_from='../storage/datasets/shark/Carcharhiniformes/'):
    a = '/media/ray/SSD/workspace/python/fish_classification/storage/datasets/korea_fish/Oncorhynchus masou/38.jpg'
    im = Image.open(a)
