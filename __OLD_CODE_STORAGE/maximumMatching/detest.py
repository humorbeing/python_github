...
class MM():
                ...
                if test[i] > 0:
                    for j in range(self.edgesum):
                        if testform[test[i]][j] == 1:
                            if j in test:
                                if Wx[j][0] == Wx[test[i]][0]:
                                    #print(Wy)
                                    Wx[test[i]][0] = Wx[test[i]][0]*1.5
                                    Wx[j][0] = Wx[j][0]*0.5
    ...
    def backward(self):
            ...
            for i in range(len(test)):
                if test[i] > 0:
                    for j in range(self.edgesum):
                        if testform[test[i]][j] == 1:
                            if j in test:
                                if Wy[j][0] == Wy[test[i]][0]:
                                    #print(Wy)
                                    Wy[test[i]][0] = Wy[test[i]][0]*1.5
                                    Wy[j][0] = Wy[j][0]*0.5
                                    test[i] = -1
                                    #print(Wy)
                                    if test[i+1] == j:
        ...
        for i in range(len(self.Xway)):
            if self.Xway[i][0] > 200.0:
                #print(self.Xway)
                self.Xway = self.Xway*0.01
                #print(self.Xway)
