...
mu = 20
laaambda = 100  # 'lambda' is conflicting with python's function.
sigma = 0.2
maxgen = 500
min_x = -1
max_x = 2
...
def representation():
    ...
    representations = mu_lambda_generation
...
def variation():
    ...
    mu_lambda_generation = lambda_generation
